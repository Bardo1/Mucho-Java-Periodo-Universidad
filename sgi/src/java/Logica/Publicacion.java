...
public abstract class Publicacion {
    ...
    protected String tipoPubli;
    protected String indice;
    
    public Publicacion(String titulo, int anioPub, String medio, int pagIni, int pagTer, String tipoPub, String indice){
        this.titulo = titulo;
